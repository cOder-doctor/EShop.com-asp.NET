<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="howtobuy.aspx.cs" Inherits="_web_project.howtobuy" %>
...
<link rel="alternate"><link rel="canonical" href="index.html"><meta name="robots" content="noodp"><meta 
    ...
    <link rel="prefetch" href="bn/ads/dhaka.html"><link rel="prerender" href="bn/ads/dhaka.html"><script> window.APIDATA = {};
                                                                                                     window.CONFIG = {};
                                                                                                     window.gtmData = [];</script>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 window.gtmData = [];</script>
    <style type="text/css">
                hr { 
  display: block;
    ...
    <asp:Button ID="Button6" runat="server" ForeColor="#339966" Height="35px" OnClick="Button6_Click" Text="লগ ইন" Width="116px" Font-Bold="True" Font-Size="Medium" />
        ...
        <br />
                            ...
                            <div class="content-container">
                                <div class="center">
     <h1  style="text-align:center;"><b><font style="color:#112C39 ;">যেভাবে  ই-শপ কাজ করে (How E-SHOP Works)</font></b> </h1>
</div>
                                <br />
  <p> &nbsp &nbsp &nbsp   &nbsp &nbsp &nbspঅনলাইন শপিং ই-শপ  ডট কম আপনার নিত্যদিনের প্রয়োজনীয় বিভিন্ন পন্যসামগ্রী যেমন, গ্যাজেটস, এক্সেসরিজ,ফ্যাশন ও লাইফস্টাইল পন্য, হেলথকেয়ার পন্য, হোম অ্যাপ্লায়েন্স ইত্যাদি পন্যের  &nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp   &nbsp উপরে নানা অফার ও আকর্ষনীয় ডিসকাউন্ট প্রদান করে থাকে। বেশিরভাগ পন্যের ক্ষেত্রে ক্রেতারা বাসায় বসে মুল্য পরিশোধ করে বাসায় পন্য গ্রহন করতে পারে।</p>
                            
                               
								
                                    <p><font style="color:#f05a28;"><b> &nbsp &nbsp &nbsp   &nbsp &nbsp &nbspযেভাবে আপনি পন্য কিনবেনঃ</font></b></p>
                                    
                                       
                                    
                                           
                                        <p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp১। আপনি যদি আমাদের নতুন অতিথি হয়ে থাকেন তাহলে যেকোন পণ্য কিনতে এখনই সাইন-আপ/রেজিস্ট্রেশন করুন।</p>
										<p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp২। আপনার নির্বাচিত পন্যটি কেনার জন্য পণ্যের ছবির উপরে ক্লিক করে অফারটির বিস্তারিত পাতায় গিয়ে ছবির পাশে ‘এখনি অর্ডার দিন’ এই বাটনে ক্লিক করুন।

</p>
										<p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp৩। আপনি যদি একাধিক পন্য কিনতে চান তাহলে ‘কার্ট এ যোগ করুন’ এই বাটনে ক্লিক করে আপনার নির্বাচিত সকল পন্য একবারে অর্ডার করুন।

</p> 
										<p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp৪। যদি ইতোমধ্যেই ই-শপ  এ আপনার একাউন্ট থেকে থাকে,তাহলে আপনার ইউজার নেম ও পাসওয়ার্ড দিয়ে সাইন ইন / লগইন করুন অথবা নতুন ক্রেতা হিসেবে  সাইন-আপ/রেজিস্ট্রেশন করে  &nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp&nbsp &nbsp &nbsp   &nbsp &nbsp &nbspআপনার নতুন একাউন্টের জন্য ইউজার নেম ও পাসওয়ার্ড তৈরি করুন।

</p>
										<p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp৫। অনুগ্রহ করে ‘ডেলিভারী ও মুল্য পরিশোধ প্রক্রিয়া’ অংশে যে যে তথ্য চাওয়া হয়েছে সেগুলো সঠিকভাবে প্রদান করুন। মনে রাখবেন আপনার প্রদানকৃত সঠিক তথ্য আপনার পন্যের ডেলিভারী &nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp    প্রক্রিয়াকে ত্বরান্বিত করবে।

</p>
										<p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp৬। এরপরে আপনি পরবর্তী ধাপে যেতে ‘পরবর্তী ধাপ’ বাটনে ক্লিক করুন।

</p>
										<p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp৭। পরবর্তী ধাপে গিয়ে আপনার অর্ডারটির সার-সংক্ষেপ পুনরায় চেক করুন ।

</p>
										<p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp৮। সব কিছু সঠিক থাকলে ‘কনফার্ম করুন’।

</p>
										<p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp৯। ২৪ ঘণ্টার মধ্যে আমাদের প্রতিনিধি আপনার সাথে ফোনে যোগাযোগ করবে।

</p>
										<p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp১০। যেকোন তথ্য সহায়তার জন্য ফোন করুন – 01867625757  (সকাল ৯টা থেকে রাত ১১ টার মধ্যে)।
