<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="paymentsuccess.aspx.cs" Inherits="_web_project.paymentsuccess" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" ForeColor="#339966" Height="36px" OnClick="Button2_Click" Text="পণ্য সংযুক্তি" Width="106px" Font-Bold="True" Font-Size="Medium" />
    ...
    <p style="margin-left: 40px">
        <strong><span class="auto-style3"><span class="auto-style2">আপনার বিকাশ,রকেট অথবা&nbsp; নগদ&nbsp; একাউন্টে গিয়ে Send money&nbsp; অপশনে গিয়ে Bkash account no = 01867625757 &nbsp; দিয়ে amount দিয়ে Reference এ আপনার Username লিখে&nbsp; পিন নাম্বার দিয়ে পাঠিয়ে দিন।</span></span></strong>
    </p>
    <p class="auto-style5" style="margin-left: 40px">
        <strong>এরপর ফিরতি এসএমএস এ পাওয়া Transaction Id টি আমাদের পাঠিয়ে দিন। </strong>
    </p>
    </div>
        <strong><span class="auto-style4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; আপনার Transaction Id টি দিনঃ<br />
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
        <asp:TextBox ID="TextBox1" runat="server" Height="35px" OnTextChanged="TextBox1_TextChanged" Width="219px"></asp:TextBox>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="TextBox1" ErrorMessage="Transaction is Required..." ForeColor="Red"></asp:RequiredFieldValidator>
        <br />
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong>
        <asp:Button ID="Button7" runat="server" BackColor="#99CCFF" Font-Bold="True" Font-Size="15pt" ForeColor="#CC0000" Height="34px" OnClick="Button7_Click" Text="Submit" Width="102px" />

        <br />

        <br />
        <br />
         <p id="demo" style= "display:none; color:red">01867625757,01521224509</p>
            <button type="button" style="color:DodgerBlue" onclick="document.getElementById('demo').style.display='block'">সাহায্য নিন</button>
        <br />                                  
