<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="replacement.aspx.cs" Inherits="_web_project.replacement" %>
    ...
    <asp:Button ID="Button6" runat="server" ForeColor="#339966" Height="35px" OnClick="Button6_Click" Text="লগ ইন" Width="116px" Font-Bold="True" Font-Size="Medium" />
        ...
        <br />
                            ...
                            <div class="content-container">
                                <div class="center">
    <h1  style="text-align:center;"><b><font style="color:#112C39 ;">রিপ্লেসমেন্ট পলিসিঃ (Replacement Policy)</font></b></h1>
</div>
                                <br />
                                <div class="details-div">
								
                                      <p ><b> <font style="color:#f05a28;">&nbsp &nbsp &nbsp   &nbsp &nbsp &nbspরিপ্লেসমেন্ট পলিসিঃ</font></b></p>
                                    <div class="sub-contents">
                                       
                                    
                                           
                                        <p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbspযে সকল প্রোডাক্টটের মূল্য ২০০০ টাকার বেশি শুধুমাত্র সেগুলোর ক্ষেত্রে কাস্টমার নিম্নের শর্ত সাপেক্ষে প্রোডাক্টটির রিপ্লেসমেন্ট সুবিধা পাবে।</p>
                                        
                                        <br /><p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp১) প্রোডাক্টের সমস্যার (যেমন : প্রোডাক্ট ভাঙ্গা, ছেঁড়া, ভুল সাইজ, প্রোডাক্ট কাজ না করা, ছবির সাথে প্রোডাক্টের মিল না থাকা ইত্যাদি) ক্ষেত্রে আপনি রিপ্লেসমেন্ট পেতে পারেন।</p>
                                        <br />&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp২) প্রোডাক্টটির বাক্স সহ সম্পূর্ণ অক্ষত অবস্থায় থাকতে হবে।
										<br /><p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp৩) ডেলিভারি গ্রহনের পর সর্বোচ্চ <font style="color:#f05a28;"><b>৪৮</b></font> ঘণ্টার মধ্যে আপনাকে complain@eshop.com এ মেইল করতে হবে অথবা <font style="color:#f05a28;"><b>01867625757</b></font> নাম্বারে কমপ্লেইন রেজিস্টার করতে হবে। 
                                        
                                                                            <br />       &nbsp &nbsp &nbsp   &nbsp &nbsp   ৪) আপনাকে উক্ত প্রোডাক্টটি ই-শপ-এর অফিসে অবশ্যই সর্বোচ্চ ৭ কার্যদিবসের মধ্যে নিজ দায়িত্বে ফেরত পাঠাতে হবে।
                                    ...
                                    <br />
                                     ...
                                     <div class="sub-contents">
                                         <div class="sub-header" > <font style="color:#f05a28;">&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp বিঃ দ্রঃ </font></div>  
                                       <p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp পণ্য ও সার্ভিস সম্পর্কিত কোনো অভিযোগের জন্য আমাদের কমপ্লেইন্ট টীম আপনাকে ফোন করবেন। এ জন্য আপনার অভিযোগটি সমাধান না হওয়া পর্যন্ত আপনাকে আমরা ফোনে সক্রিয় পেতে &nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp  চাই। আপনার যোগাযোগে দেওয়া নম্বরটি সক্রিয় না থাকলে বিকল্প কোনো নম্বর সক্রিয় থাকতে হবে। রিফান্ডের জন্য আপনাকে টাকাটি ফেরতের মাধ্যম আমাদের জানাতে হবে। আমরা আপনার কোনো &nbsp &nbsp &nbsp   &nbsp &nbsp প্রকার সহযোগিতা ১৫ কার্যদিবসের মধ্যে ফোনে অথবা ইমেইলে না পেলে আপনার অভিযোগটি নিস্পত্তি বলে মনে করবো।</p>
                                     </div>
                                </div>

                                  <br><br>
                                    <div class="phone-number-wrapper">
                                        <font style="color:#f05a28;"><b> &nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp ফোন : </b></font><font style="color:#f05a28;"><b>01867625757</b></font></b><br><br>
                                        <font style="color:#f05a28;"><b>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp ইমেইল</b></font> &nbsp:&nbsp;info@eshop.com, complain@eshop.com<br>
