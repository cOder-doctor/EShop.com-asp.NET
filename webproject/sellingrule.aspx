<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sellingrule.aspx.cs" Inherits="_web_project.sellingrule" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" ForeColor="#339966" Height="36px" OnClick="Button2_Click" Text="পণ্য সংযুক্তি" Width="106px" Font-Bold="True" Font-Size="Medium" />
  ...
  <p> &nbsp &nbsp &nbsp   &nbsp &nbsp &nbspঅনলাইন শপিং ই-শপ  ডট কম আপনার নিত্যদিনের প্রয়োজনীয় বিভিন্ন পন্যসামগ্রী যেমন, গ্যাজেটস, এক্সেসরিজ,ফ্যাশন ও লাইফস্টাইল পন্য, হেলথকেয়ার পন্য, হোম অ্যাপ্লায়েন্স ইত্যাদি পন্যের  &nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp   &nbsp উপরে নানা অফার ও আকর্ষনীয় ডিসকাউন্ট প্রদান করে থাকে। বেশিরভাগ পন্যের ক্ষেত্রে ক্রেতারা বাসায় বসে মুল্য পরিশোধ করে বাসায় পন্য গ্রহন করতে পারে।</p>
                                    ...
                                    <p><font style="color:#f05a28;"><b> &nbsp &nbsp &nbsp   &nbsp &nbsp &nbspযেভাবে আপনি পন্য কিনবেনঃ</font></b></p>
										...
										<p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp২। আমাদের সাইটে প্রবেশ করে পণ্য সংযুক্তি অপশনে প্রবেশ করুন।
</p>
										<p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp৩। এরপর আপনার প্রোডাক্টের নাম,মূল্যসহ সকল ফিল্ড পূরন করুন।</p> 
										<p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp৪। এরপর পণ্যের ছবি সংযুক্ত করে submit বাটনে ক্লিক করুন। 
